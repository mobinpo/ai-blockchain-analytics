...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configure fallback explorers for when primary explorers fail
    |
    */

    'fallbacks' => [
        'ethereum' => [], // No direct fallbacks for Ethereum
        'bsc' => [], // BSC has limited alternatives
        'polygon' => [], // PolygonScan is primary
        'arbitrum' => ['ethereum'], // Can fallback to Etherscan for some data
        'optimism' => ['ethereum'], // Can fallback to Etherscan for some data
        'avalanche' => [], // Snowtrace is primary
        'fantom' => [], // FTMScan is primary
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Configure health checks for explorer APIs
    |
    */

    'health_check' => [
        'enabled' => env('BLOCKCHAIN_EXPLORER_HEALTH_CHECK', true),
        'interval' => env('BLOCKCHAIN_EXPLORER_HEALTH_CHECK_INTERVAL', 300), // 5 minutes
        'cache_key_prefix' => 'explorer_health:',
        'failure_threshold' => env('BLOCKCHAIN_EXPLORER_FAILURE_THRESHOLD', 3),
        'recovery_attempts' => env('BLOCKCHAIN_EXPLORER_RECOVERY_ATTEMPTS', 5),
    ],
    ...
    */
    ...
    'load_balancing' => [
        'enabled' => env('BLOCKCHAIN_EXPLORER_LOAD_BALANCING', false),
        'strategy' => env('BLOCKCHAIN_EXPLORER_LB_STRATEGY', 'round_robin'), // round_robin, least_used, random
        'multiple_keys' => [
            'etherscan' => env('ETHERSCAN_API_KEYS', ''), // comma-separated keys
            'bscscan' => env('BSCSCAN_API_KEYS', ''),
            'polygonscan' => env('POLYGONSCAN_API_KEYS', ''),
        ],
    ],
];